...
#    If not, see <http://www.gnu.org/licenses/>.
{
    ...
    'data': [
        ...
        'structure/event/lifecycle.xml',
        'structure/event/property.xml',
        'structure/event/identifier.xml',
        'structure/agent/security.xml',
        'structure/agent/view.xml',
        'structure/agent/lifecycle.xml',
        'structure/agent/property.xml',
        'structure/agent/identifier.xml',
        'structure/commitment/security.xml',
        'structure/commitment/view.xml',
        'structure/commitment/lifecycle.xml',
        'structure/commitment/property.xml',
        'structure/commitment/identifier.xml',
        'structure/contract/security.xml',
        'structure/contract/view.xml',
        'structure/contract/lifecycle.xml',
        'structure/contract/property.xml',
        'structure/contract/identifier.xml',
        'structure/event/duality/security.xml',
        'structure/event/duality/view.xml',
        'structure/event/duality/lifecycle.xml',
        'structure/event/duality/property.xml',
        'structure/event/duality/identifier.xml',
